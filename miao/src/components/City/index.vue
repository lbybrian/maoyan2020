	...
	<div class="city_body">
		<!--<div class="city_list">
			...
			<div class="city_sort" ref="city_sort">
				<div v-for="a in cityList" :key="a.index">
					<h2>{{a.index}}</h2>
					<ul>
						<li v-for="itemList in a.list" :key="itemList.index">{{itemList.nm}}</li>
					</ul>
				</div>
			</div>
		</div>
			<div class="city_index">
					<ul>
						<li v-for="(item,check) in cityList" :key="item.id" @touchstart="abc(check)">{{item.index}}</li>
					</ul>
			</div>-->
		<div class="city_list">
